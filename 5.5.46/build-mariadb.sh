#! /bin/bash --
# by pts@fazekas.hu at 2010-08-09 | Modified by dobell 2015-12-01
...
TARGZ=mariadb-5.5.46-linux-i686.tar.gz
TARGZ_URL=http://tedeco.fi.upm.es/mirror/mariadb//mariadb-5.5.46/bintar-linux-x86/mariadb-5.5.46-linux-i686.tar.gz
